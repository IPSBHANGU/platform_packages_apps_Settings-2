...
public class AospVersionDialogController  implements View.OnClickListener {
    ...
    @VisibleForTesting
    static final int AOSP_VERSION_VALUE_ID = R.id.aosp_version_value;
    @VisibleForTesting
    static final int AOSP_VERSION_LABEL_ID = R.id.aosp_version_label;
    ...
    public void initialize() {
        ...
        mDialog.setText(AOSP_VERSION_VALUE_ID,
                BidiFormatter.getInstance().unicodeWrap(Build.AOSP_DISPLAY_VERSION));
    }

    private void registerClickListeners() {
        mDialog.registerClickListener(AOSP_VERSION_LABEL_ID, this /* listener */);
        mDialog.registerClickListener(AOSP_VERSION_VALUE_ID, this /* listener */);
    }
